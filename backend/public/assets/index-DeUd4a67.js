...
function re(t, e, n) {
  const s = t.getProps();
  return yt(s, e, n !== void 0 ? n : s.custom, t);
}
const Un = Ee(() => window.ScrollTimeline !== void 0);
class jn {
  constructor(e) {
  ...
  attachTimeline(e, n) {
    const s = this.animations.map(i => {
      if (Un() && i.attachTimeline) return i.attachTimeline(e);
...
function Dt(t) {
  ...
  const n = 50;
  let s = t.next(e);
  for (; !s.done && e < be; ) ((e += n), (s = t.next(e)));
  return e >= be ? 1 / 0 : e;
}
function Oe(t) {
...
const Ke = t => Array.isArray(t) && typeof t[0] == 'number',
  zn = { linearEasing: void 0 };
function qn(t, e) {
  const n = Ee(t);
  return () => {
    var s;
    return (s = zn[e]) !== null && s !== void 0 ? s : n();
  };
}
const Q = qn(() => {
    try {
  ...
  It = (t, e, n = 10) => {
    ...
    for (let r = 0; r < i; r++) s += t(Re(0, i - 1, r)) + ', ';
...
function Et(t) {
  return !!(
    (typeof t == 'function' && Q()) ||
    !t ||
    (typeof t == 'string' && (t in Te || Q())) ||
    Ke(t) ||
    (Array.isArray(t) && t.every(Et))
  );
}
const q = ([t, e, n, s]) => `cubic-bezier(${t}, ${e}, ${n}, ${s})`,
  Te = {
    linear: 'linear',
    ease: 'ease',
    easeIn: 'ease-in',
...
function Rt(t, e) {
  if (t)
    return typeof t == 'function' && Q()
      ? It(t, e)
      : Ke(t)
        ? q(t)
        : Array.isArray(t)
          ? t.map(n => Rt(n, e) || Te.easeOut)
          : Te[t];
}
const Hn = { y: !1 };
function $n() {
...
const Kt = (t, e) => (e ? (t === e ? !0 : Kt(t, e.parentElement)) : !1),
  Zn = t =>
...
function ts(t, e, n = {}) {
      ...
      const u = e(a),
        c = (f, b) => {
          (window.removeEventListener('pointerup', h),
            ...
            !(!Ze(f) || !H.has(l)) &&
              (H.delete(l), typeof u == 'function' && u(f, { success: b })));
        },
        h = f => {
          c(f, n.useGlobalTarget || Kt(l, f.target));
        },
        d = f => {
          c(f, !1);
        };
  ...
  return (
    s.forEach(a => {
      (!Qn(a) && a.getAttribute('tabindex') === null && (a.tabIndex = 0),
        (n.useGlobalTarget ? window : a).addEventListener('pointerdown', o, i),
        a.addEventListener('focus', u => es(u, i), i));
    }),
    r
  );
}
const Nt = new Set(['width', 'height', 'top', 'left', 'right', 'bottom', ...bt]);
let Z;
function ns() {
  Z = void 0;
}
const K = {
  now: () => (
    Z === void 0 && K.set(J.isProcessing || Tt.useManualTiming ? J.timestamp : performance.now()),
    Z
  ),
  set: t => {
    ((Z = t), queueMicrotask(ns));
  },
};
function ss(t, e) {
...
class Bt {
  ...
  add(e) {
    return (ss(this.subscriptions, e), () => is(this.subscriptions, e));
  }
  notify(e, n, s) {
...
class os {
  ...
  setCurrent(e) {
    ((this.current = e),
      ...
      this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = rs(this.current)));
  }
...
function cs(t, e) {
  ...
  if (us(n)) return n.add(e);
}
function hs(t) {
  return t.props[An];
}
const kt = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t,
  ds = 1e-7,
  fs = 12;
function ps(t, e, n, s, i) {
  let r,
    o,
    a = 0;
  do ((o = e + (n - e) / 2), (r = kt(o, s, i) - t), r > 0 ? (n = o) : (e = o));
  while (Math.abs(r) > ds && ++a < fs);
  return o;
}
function X(t, e, n, s) {
  if (t === e && n === s) return G;
  const i = r => ps(r, 0, 1, t, n);
  return r => (r === 0 || r === 1 ? r : kt(i(r), e, s));
}
const _t = t => e => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
  Gt = t => e => 1 - t(1 - e),
  Ut = X(0.33, 1.53, 0.69, 0.99),
  Ne = Gt(Ut),
  jt = _t(Ne),
  Wt = t => ((t *= 2) < 1 ? 0.5 * Ne(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
...
const ys =
  ...
  ke = (t, e) => n =>
    !!(
      ...
      (e && !vs(n) && Object.prototype.hasOwnProperty.call(n, e))
    ),
  Ht = (t, e, n) => s => {
    if (typeof s != 'string') return s;
    const [i, r, o, a] = s.match(Le);
    return {
      [t]: parseFloat(i),
      [e]: parseFloat(r),
      [n]: parseFloat(o),
  ...
  bs = t => U(0, 255, t),
  de = { ...De, transform: t => Math.round(bs(t)) },
  B = {
    test: ke('rgb', 'red'),
...
const Ve = { test: ke('#'), parse: Ts, transform: B.transform },
  _ = {
    test: ke('hsl', 'hue'),
  ...
  x = {
    test: t => B.test(t) || Ve.test(t) || _.test(t),
    parse: t => (B.test(t) ? B.parse(t) : _.test(t) ? _.parse(t) : Ve.parse(t)),
    transform: t =>
      typeof t == 'string' ? t : t.hasOwnProperty('red') ? B.transform(t) : _.transform(t),
  },
  Vs =
...
function As(t) {
  ...
  return (
    isNaN(t) &&
    typeof t == 'string' &&
    (((e = t.match(Le)) === null || e === void 0 ? void 0 : e.length) || 0) +
...
function Y(t) {
  ...
  const a = e
    .replace(
      ...
      l => (
        x.test(l)
          ? (s.color.push(r), i.push(Yt), n.push(x.parse(l)))
          : l.startsWith(ws)
            ? (s.var.push(r), i.push(Ss), n.push(l))
            : (s.number.push(r), i.push($t), n.push(parseFloat(l))),
        ++r,
        Qe
      ),
    )
...
function Zt(t) {
  ...
  return i => {
    ...
    for (let o = 0; o < s; o++)
      if (((r += e[o]), i[o] !== void 0)) {
        const a = n[o];
        a === $t ? (r += $(i[o])) : a === Yt ? (r += x.transform(i[o])) : (r += i[o]);
      }
    return r;
  };
}
const Ps = t => (typeof t == 'number' ? 0 : t);
function Cs(t) {
  const e = Xt(t);
  return Zt(t)(e.map(Ps));
}
const W = { test: As, parse: Xt, createTransformer: Zt, getAnimatableNone: Cs },
  Ms = new Set(['brightness', 'contrast', 'saturate', 'opacity']);
function Fs(t) {
...
function Jt(t, e) {
  let n = _e(t);
  return (n !== Ae && (n = W), n.getAnimatableNone ? n.getAnimatableNone(e) : void 0);
}
...
function Rs(t, e, n) {
  ...
  for (; s < t.length && !i; ) {
    const r = t[s];
    (typeof r == 'string' && !Es.has(r) && Y(r).values.length && (i = t[s]), s++);
  }
  if (i && n) for (const r of e) t[r] = Jt(n, i);
}
const et = t => t === De || t === At,
  tt = (t, e) => parseFloat(t.split(', ')[e]),
  nt =
    (t, e) =>
    (n, { transform: s }) => {
      if (s === 'none' || !s) return 0;
      const i = s.match(/^matrix3d\((.+)\)$/u);
      if (i) return tt(i[1], e);
      {
...
function Qt() {
  if (we) {
    const t = Array.from(L).filter(s => s.needsMeasurement),
  ...
  ((we = !1), (Se = !1), L.forEach(t => t.complete()), L.clear());
}
function en() {
  L.forEach(t => {
...
class Ge {
  ...
  scheduleResolve() {
    ((this.isScheduled = !0),
      this.isAsync
        ? (L.add(this), Se || ((Se = !0), D.read(en), D.resolveKeyframes(Qt)))
...
const tn = t => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t),
  Ls = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u;
function ks(t) {
  const e = Ls.exec(t);
  if (!e) return [,];
  const [, n, s, i] = e;
...
function nn(t, e, n = 1) {
  ...
  if (r) {
    const o = r.trim();
    return tn(o) ? parseFloat(o) : o;
  }
  return Ie(i) ? nn(i, e, n + 1) : i;
}
const sn = t => e => e.test(t),
  _s = { test: t => t === 'auto', parse: t => t },
  rn = [De, At, ve, wn, xn, Pn, _s],
  st = t => rn.find(sn(t));
class on extends Ge {
  ...
  readKeyframes() {
    ...
    if ((this.resolveNoneKeyframes(), !Nt.has(s) || e.length !== 2)) return;
    const [i, r] = e,
      o = st(i),
      a = st(r);
    if (o !== a)
  ...
  resolveNoneKeyframes() {
    const { unresolvedKeyframes: e, name: n } = this,
      s = [];
    for (let i = 0; i < e.length; i++) gs(e[i]) && s.push(i);
    s.length && Rs(e, s, n);
  }
  measureInitialState() {
    ...
    (s === 'height' && (this.suspendedScrollY = window.pageYOffset),
      (this.measuredOrigin = j[s](e.measureViewportBox(), window.getComputedStyle(e.current))),
  ...
  measureEndState() {
    ...
    const o = i.length - 1,
      a = i[o];
    ((i[o] = j[s](n.measureViewportBox(), window.getComputedStyle(n.current))),
...
const it = (t, e) =>
  e === 'zIndex'
    ...
    : !!(
        typeof t == 'number' ||
        Array.isArray(t) ||
        (typeof t == 'string' && (W.test(t) || t === '0') && !t.startsWith('url('))
      );
function Gs(t) {
  const e = t[0];
...
function Us(t, e, n, s) {
  ...
  const r = t[t.length - 1],
    o = it(i, e),
    a = it(r, e);
  return !o || !a ? !1 : Gs(t) || ((n === 'spring' || Oe(n)) && s);
}
const js = t => t !== null;
...
class an {
  ...
  calcStartTime() {
    return this.resolvedAt
      ? this.resolvedAt - this.createdAt > Ws
        ? this.resolvedAt
        : this.createdAt
      : this.createdAt;
  }
...
function zs({ hue: t, saturation: e, lightness: n, alpha: s }) {
  ((t /= 360), (e /= 100), (n /= 100));
  let i = 0,
    r = 0,
    o = 0;
  if (!e) i = r = o = n;
    ...
    const a = n < 0.5 ? n * (1 + e) : n + e - n * e,
      l = 2 * n - a;
    ((i = fe(l, a, t + 1 / 3)), (r = fe(l, a, t)), (o = fe(l, a, t - 1 / 3)));
  }
  return {
...
function Zs(t, e) {
  const n = { ...t, ...e },
    s = {};
  for (const i in n) t[i] !== void 0 && e[i] !== void 0 && (s[i] = Ue(t[i])(t[i], e[i]));
  return i => {
...
function ti({
  ...
  let i,
    r,
    o = 1 - e;
  ((o = U(S.minDamping, S.maxDamping, o)),
    (t = U(S.minDuration, S.maxDuration, O(t))),
    o < 1
      ? ((i = u => {
          const c = u * o,
            h = c * t,
  ...
  const a = 5 / t,
    l = si(i, r, a);
  if (((t = R(t)), isNaN(l))) return { stiffness: S.stiffness, damping: S.damping, duration: t };
  {
...
function si(t, e, n) {
  let s = n;
  for (let i = 1; i < ni; i++) s = s - t(s) / e(s);
  return s;
}
function Pe(t, e) {
  return t * Math.sqrt(1 - e * e);
}
const ii = ['duration', 'bounce'],
  ri = ['stiffness', 'damping', 'mass'];
function at(t, e) {
  ...
  if (!at(t, ri) && at(t, ii))
    if (t.visualDuration) {
      const n = t.visualDuration,
        s = (2 * Math.PI) / (n * 1.2),
        i = s * s,
        r = 2 * U(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(i);
      e = { ...e, mass: S.mass, stiffness: i, damping: r };
    } else {
      const n = ti(t);
      ((e = { ...e, ...n, mass: S.mass }), (e.isResolvedFromDuration = !0));
    }
  return e;
}
function hn(t = S.visualDuration, e = S.bounce) {
  ...
  const r = n.keyframes[0],
    ...
    } = oi({ ...n, velocity: -O(n.velocity || 0) }),
    b = d || 0,
    v = u / (2 * Math.sqrt(l * c)),
    y = o - r,
    g = O(Math.sqrt(l / c)),
    T = Math.abs(y) < 5;
  (s || (s = T ? S.restSpeed.granular : S.restSpeed.default),
    i || (i = T ? S.restDelta.granular : S.restDelta.default));
  let V;
  if (v < 1) {
    const m = Pe(g, v);
    V = A => {
      const w = Math.exp(-v * g * A);
      return o - w * (((b + v * g * y) / m) * Math.sin(m * A) + y * Math.cos(m * A));
    };
  } else if (v === 1) V = m => o - Math.exp(-g * m) * (y + (b + g * y) * m);
  else {
    const m = g * Math.sqrt(v * v - 1);
    V = A => {
      const w = Math.exp(-v * g * A),
        p = Math.min(m * A, 300);
      return o - (w * ((b + v * g * y) * Math.sinh(p) + m * y * Math.cosh(p))) / m;
    };
  }
  const M = {
    ...
    next: m => {
      ...
      if (f) a.done = m >= h;
        ...
        let w = 0;
        v < 1 && (w = m === 0 ? R(b) : cn(V, m, A));
        const p = Math.abs(w) <= s,
          C = Math.abs(o - A) <= i;
        a.done = p && C;
      }
    ...
    toString: () => {
      const m = Math.min(Dt(M), be),
        A = It(w => M.next(m * w).value, m, 30);
      return m + 'ms ' + A;
    },
  };
  return M;
...
function lt({
  ...
  const h = t[0],
    d = { done: !1, value: h },
    f = p => (a !== void 0 && p < a) || (l !== void 0 && p > l),
    b = p => (a === void 0 ? l : l === void 0 || Math.abs(a - p) < Math.abs(l - p) ? a : l);
  let v = n * e;
  const y = h + v,
    g = o === void 0 ? y : o(y);
  g !== y && (v = g - h);
  const T = p => -v * Math.exp(-p / s),
    V = p => g + T(p),
    M = p => {
      const C = T(p),
        F = V(p);
      ((d.done = Math.abs(C) <= u), (d.value = d.done ? g : F));
    };
  let m, A;
  const w = p => {
    f(d.value) &&
  ...
  return (
    w(0),
    {
      ...
      next: p => {
        let C = !1;
        return (
          !A && m === void 0 && ((C = !0), M(p), w(p)),
          m !== void 0 && p >= m ? A.next(p - m) : (!C && M(p), d)
        );
      },
    }
  );
}
const ai = X(0.42, 0, 1, 1),
  li = X(0, 0, 0.58, 1),
  dn = X(0.42, 0, 0.58, 1),
  ...
  ut = t => {
    if (Ke(t)) {
      ...
      const [e, n, s, i] = t;
      return X(e, n, s, i);
    } else if (typeof t == 'string') return ci[t];
    return t;
  };
function hi(t, e, n) {
  const s = [],
...
function di(t, e, { clamp: n = !0, ease: s, mixer: i } = {}) {
  const r = t.length;
  if ((Ct(r === e.length), r === 1)) return () => e[0];
...
function ne({ duration: t = 300, keyframes: e, times: n, ease: s = 'easeInOut' }) {
  const i = ui(s) ? s.map(ut) : ut(s),
    r = { done: !1, value: e[0] },
    o = mi(n && n.length === e.length ? n : pi(e), t),
    a = di(o, e, { ease: Array.isArray(i) ? i : gi(e, i) });
...
const vi = t => {
    ...
    return {
      start: () => D.update(e, !0),
      stop: () => ye(e),
      now: () => (J.isProcessing ? J.timestamp : K.now()),
    };
  },
  yi = { decay: lt, inertia: lt, tween: ne, keyframes: ne, spring: hn },
  bi = t => t / 100;
class je extends an {
  constructor(e) {
    (super(e),
  ...
  initPlayback(e) {
    const {
      ...
      a = Oe(n) ? n : yi[n] || ne;
    let l, u;
    a !== ne && typeof e[0] != 'number' && ((l = le(bi, un(e[0], e[1]))), (e = [0, 100]));
    const c = a({ ...this.options, keyframes: e });
    (r === 'mirror' && (u = a({ ...this.options, keyframes: [...e].reverse(), velocity: -o })),
      c.calculatedDuration === null && (c.calculatedDuration = Dt(c)));
  ...
  tick(e, n = !1) {
    ...
    if (f) {
      ...
      (!F && p >= 1 && (F = 1),
        ...
        (C = Math.min(C, f + 1)),
        !!(C % 2) &&
          (b === 'reverse' ? ((F = 1 - F), v && (F -= v / h)) : b === 'mirror' && (M = o)),
        (V = U(0, 1, F) * h));
    }
    const m = T ? { done: !1, value: l[0] } : M.next(V);
    a && (m.value = a(m.value));
    let { done: A } = m;
    ...
    return (
      w && i !== void 0 && (m.value = oe(l, this.options, i)),
      y && y(m.value),
      w && this.finish(),
      m
    );
  ...
  get duration() {
    ...
    return e ? O(e.calculatedDuration) : 0;
  }
  get time() {
  ...
  set speed(e) {
    ...
    ((this.playbackSpeed = e), n && (this.time = O(this.currentTime)));
  }
  play() {
    ...
    const { driver: e = vi, onPlay: n, startTime: s } = this.options;
...
const Ti = new Set(['opacity', 'clipPath', 'filter', 'transform']);
function Vi(
  t,
  e,
  n,
...
const Ai = Ee(() => Object.hasOwnProperty.call(Element.prototype, 'animate')),
  se = 10,
  Si = 2e4;
function wi(t) {
  return Oe(t.type) || t.type === 'spring' || !Et(t.ease);
}
function xi(t, e) {
  const n = new je({ ...e, keyframes: t, repeat: 0, delay: 0, isGenerator: !0 });
  let s = { done: !1, value: t[0] };
  const i = [];
  let r = 0;
  for (; !s.done && r < Si; ) ((s = n.sample(r)), i.push(s.value), (r += se));
  return { times: void 0, keyframes: i, duration: r - se, ease: 'linear' };
}
const fn = { anticipate: Wt, backInOut: jt, circInOut: zt };
function Pi(t) {
  return t in fn;
}
class ct extends an {
  constructor(e) {
    super(e);
    const { name: n, motionValue: s, element: i, keyframes: r } = this.options;
    ((this.resolver = new on(r, (o, a) => this.onKeyframesResolved(o, a), n, s, i)),
  ...
  initPlayback(e, n) {
    ...
    if ((typeof r == 'string' && Q() && Pi(r) && (r = fn[r]), wi(this.options))) {
      const { onComplete: h, onUpdate: d, motionValue: f, element: b, ...v } = this.options,
        y = xi(e, v);
      ((e = y.keyframes),
        e.length === 1 && (e[1] = e[0]),
        (s = y.duration),
    ...
    const c = Vi(a.owner.current, l, e, { ...this.options, duration: s, times: i, ease: r });
    return (
      (c.startTime = u ?? this.calcStartTime()),
      this.pendingTimeline
        ? ($e(c, this.pendingTimeline), (this.pendingTimeline = void 0))
        : (c.onfinish = () => {
            const { onComplete: h } = this.options;
            (a.set(oe(e, this.options, n)), h && h(), this.cancel(), this.resolveFinishedPromise());
          }),
  ...
  stop() {
    ...
    if (this.time) {
      const { motionValue: u, onUpdate: c, onComplete: h, element: d, ...f } = this.options,
        b = new je({
          ...f,
          keyframes: s,
          duration: i,
        ...
        v = R(this.time);
      u.setWithVelocity(b.sample(v - se).value, b.sample(v).value, se);
    }
    const { onStop: l } = this.options;
    (l && l(), this.cancel());
  }
  ...
  static supports(e) {
    ...
    return Ai() && s && Ti.has(s) && !l && !u && !i && r !== 'mirror' && o !== 0 && a !== 'inertia';
  }
}
const Ci = { type: 'spring', stiffness: 500, damping: 25, restSpeed: 10 },
  ...
  Ii = (t, { keyframes: e }) =>
    e.length > 2 ? Fi : ie.has(t) ? (t.startsWith('scale') ? Mi(e[1]) : Ci) : Di;
function Ei({
  when: t,
  delay: e,
  delayChildren: n,
...
const Ri =
  ...
  o => {
    ...
    if (
      ...
      Tt.skipAnimations && ((h = !0), (c.duration = 0), (c.delay = 0)),
      h && !r && e.get() !== void 0)
    ) {
      const d = oe(c.keyframes, a);
      if (d !== void 0)
        return (
          D.update(() => {
    ...
    return !r && ct.supports(c) ? new ct(c) : new je(c);
  };
function Oi({ protectedKeys: t, needsAnimating: e }, n) {
  const s = t.hasOwnProperty(n) && e[n] !== !0;
  return ((e[n] = !1), s);
}
function pn(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
  var r;
  ...
  for (const h in l) {
    const d = t.getValue(h, (r = t.latestValues[h]) !== null && r !== void 0 ? r : null),
      f = l[h];
    if (f === void 0 || (c && Oi(c, h))) continue;
    const b = { delay: n, ...Ft(o || {}, h) };
    let v = !1;
    if (window.MotionHandoffAnimation) {
      const g = hs(t);
      if (g) {
        const T = window.MotionHandoffAnimation(g, h, D);
        T !== null && ((b.startTime = T), (v = !0));
      }
    }
    (cs(t, h), d.start(Ri(h, d, f, t.shouldReduceMotion && Nt.has(h) ? { type: !1 } : b, t, v)));
    const y = d.animation;
    y && u.push(y);
  }
  return (
    ...
    Array.from(t.variantChildren)
      ...
      .forEach((u, c) => {
        (u.notify('AnimationStart', e),
          o.push(Ce(u, e, { ...r, delay: n + l(c) }).then(() => u.notify('AnimationComplete', e))));
      }),
    Promise.all(o)
  );
}
...
function Bi(t, e, n = {}) {
  ...
  let s;
  if (Array.isArray(e)) {
    const i = e.map(r => Ce(t, r, n));
    s = Promise.all(i);
  } else if (typeof e == 'string') s = Ce(t, e, n);
  else {
    const i = typeof e == 'function' ? re(t, e, n.custom) : e;
    s = Promise.all(pn(t, i, n));
  }
  return s.then(() => {
...
const ki = [...Pt].reverse(),
  _i = Pt.length;
function Gi(t) {
  return e => Promise.all(e.map(({ animation: n, options: s }) => Bi(t, n, s)));
}
function Ui(t) {
  let e = Gi(t),
    n = ht(),
  ...
  function o(l) {
    ...
    for (let y = 0; y < _i; y++) {
      const g = ki[y],
        ...
        M = St(V),
        m = g === l ? T.isActive : null;
      m === !1 && (b = y);
      let A = V === c[g] && V !== u[g] && M;
      if (
        (A && s && t.manuallyAnimateOnMount && (A = !1),
        (T.protectedKeys = { ...f }),
        (!T.isActive && m === null) || (!V && !T.prevProp) || xt(V) || typeof V == 'boolean')
      )
        continue;
      const w = ji(T.prevProp, V);
      let p = w || (g === l && T.isActive && !A && M) || (y > b && M),
        C = !1;
      const F = Array.isArray(V) ? V : [V];
      let k = F.reduce(i(g), {});
      m === !1 && (k = {});
      const { prevResolvedValues: We = {} } = T,
        Tn = { ...We, ...k },
        ze = P => {
          ((p = !0), d.has(P) && ((C = !0), d.delete(P)), (T.needsAnimating[P] = !0));
          const I = t.getValue(P);
          I && (I.liveStyle = !1);
        };
      for (const P in Tn) {
        const I = k[P],
      ...
      ((T.prevProp = V),
        (T.prevResolvedValues = k),
        T.isActive && (f = { ...f, ...k }),
        s && t.blockInitialAnimation && (p = !1),
        p && (!(A && w) || C) && h.push(...F.map(P => ({ animation: P, options: { type: g } }))));
    }
    if (d.size) {
      const y = {};
      (d.forEach(g => {
    ...
    let v = !!h.length;
    return (
      s && (u.initial === !1 || u.initial === u.animate) && !t.manuallyAnimateOnMount && (v = !1),
      (s = !1),
...
function ji(t, e) {
  return typeof e == 'string' ? e !== t : Array.isArray(e) ? !Mt(e, t) : !1;
}
function N(t = !1) {
...
class Wi extends z {
  constructor(e) {
    (super(e), e.animationState || (e.animationState = Ui(e)));
  }
...
const Hi = { animation: { Feature: Wi }, exit: { Feature: qi } };
...
const ft = () => ({ min: 0, max: 0 }),
  vn = () => ({ x: ft(), y: ft() });
function $i({ top: t, left: e, right: n, bottom: s }) {
...
function Xi(t, e) {
  return $i(Yi(t.getBoundingClientRect(), e));
}
function pt(t, e, n) {
  const { props: s } = t;
  ...
  const i = 'onHover' + n,
    r = s[i];
  r && D.postRender(() => r(e, gn(e)));
}
class Zi extends z {
  mount() {
    const { current: e } = this.node;
    e && (this.unmount = Xn(e, n => (pt(this.node, n, 'Start'), s => pt(this.node, s, 'End'))));
  }
  unmount() {}
}
class Ji extends z {
  ...
  mount() {
    ...
    e &&
      (this.unmount = ts(
        e,
        n => (
          mt(this.node, n, 'Start'),
          (s, { success: i }) => mt(this.node, s, i ? 'End' : 'Cancel')
        ),
  ...
  startObserver() {
    ...
    const { viewport: e = {} } = this.node.getProps(),
      ...
      o = {
        ...
        rootMargin: s,
        threshold: typeof i == 'number' ? i : ir[i],
      },
      a = l => {
    ...
    return sr(this.node.current, o, a);
  }
  mount() {
    this.startObserver();
  }
...
function hr(t, e, n) {
  for (const s in e) {
    ...
    else if (E(r)) t.addValue(s, ee(i, { owner: t }));
    else if (r !== i)
      if (t.hasValue(s)) {
        ...
        t.addValue(s, ee(o !== void 0 ? o : i, { owner: t }));
      }
  }
...
class dr {
  ...
  constructor(
    ...
    ((this.onUpdate = c),
      ...
      (this.isControllingVariants = Mn(n)),
      (this.isVariantNode = Fn(n)),
      this.isVariantNode && (this.variantChildren = new Set()),
      (this.manuallyAnimateOnMount = !!(e && e.current)));
    const { willChange: h, ...d } = this.scrapeMotionValuesFromProps(n, {}, this);
    for (const f in d) {
      const b = d[f];
      l[f] !== void 0 && E(b) && b.set(l[f], !1);
    }
  }
  mount(e) {
    ((this.current = e),
  ...
  unmount() {
    (gt.delete(this.current),
      this.projection && this.projection.unmount(),
      ye(this.notifyUpdate),
      ye(this.render),
  ...
  measureViewportBox() {
    return this.current ? this.measureInstanceViewportBox(this.current, this.props) : vn();
  }
  getStaticValue(e) {
  ...
  getValue(e, n) {
    ...
    return (
      s === void 0 &&
        n !== void 0 &&
        ((s = ee(n === null ? void 0 : n, { owner: this })), this.addValue(e, s)),
      s
    );
  }
  readValue(e, n) {
    ...
    let i =
      this.latestValues[e] !== void 0 || !this.current
        ? this.latestValues[e]
        : (s = this.getBaseTargetFromProps(this.props, e)) !== null && s !== void 0
          ? s
          : this.readValueFromInstance(this.current, e, this.options);
    return (
      i != null &&
        (typeof i == 'string' && (tn(i) || qt(i))
          ? (i = parseFloat(i))
          : !cr(i) && W.test(n) && (i = Jt(e, n)),
  ...
  on(e, n) {
    return (this.events[e] || (this.events[e] = new Bt()), this.events[e].add(n));
  }
  notify(e, ...n) {
...
class pr extends bn {
  ...
  readValueFromInstance(e, n) {
    if (ie.has(n)) {
      ...
      const s = fr(e),
        i = (In(n) ? s.getPropertyValue(n) : s[n]) || 0;
...
class mr extends bn {
  constructor() {
    (super(...arguments),
      (this.type = 'svg'),
      (this.isSVGTag = !1),
      (this.measureInstanceViewportBox = vn));
  }
  getBaseTargetFromProps(e, n) {
    return e[n];
  }
  readValueFromInstance(e, n) {
    ...
    return ((n = Kn.has(n) ? n : On(n)), e.getAttribute(n));
  }
  scrapeMotionValuesFromProps(e, n, s) {
    return Nn(e, n, s);
  }
  build(e, n, s) {
    Bn(e, n, this.isSVGTag, s.transformTemplate);
  }
...
const gr = (t, e) => (_n(t) ? new mr(e) : new pr(e, { allowProjection: t !== Gn.Fragment })),
  vr = { renderer: gr, ...Hi, ...ar };
var Vr = vr;
export { Vr as default };
//# sourceMappingURL=index-DeUd4a67.js.map
