              ...
              <div className="font-mono text-xs leading-5 h-[400px] overflow-auto p-3 bg-white dark:bg-gray-900/50">
                {left.map((line, i) => (
                  <div key={i} className={`whitespace-pre-wrap ${
                    line.startsWith("-") ? "text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/10" :
                    line.startsWith("~") ? "text-yellow-600 dark:text-yellow-400 bg-yellow-50 dark:bg-yellow-900/10" :
          ...
          <Card className="border border-gray-200 dark:border-gray-700">
            ...
            <CardBody className="p-0">
              <div className="font-mono text-xs leading-5 h-[400px] overflow-auto p-3 bg-white dark:bg-gray-900/50">
                {right.map((line, i) => (
                  <div key={i} className={`whitespace-pre-wrap ${
                    line.startsWith("+") ? "text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/10" :
                    line.startsWith("~") ? "text-yellow-600 dark:text-yellow-400 bg-yellow-50 dark:bg-yellow-900/10" :
                    "text-gray-700 dark:text-gray-300"
                  }`}>
                    {line}
